...
| ----------------------------- | ----------------------------- | ------------------- | --------------- | --------------------------- | -------------------- | --------------- | --------------- | ------------------------ | -------------------- | ----------------- | -------------------- | --------------------------- | ------------------------ | --------------- | ------------------ | --------------------- | --------- | -------------------- | ----------------------- | ---------------------- | ----------------------- | - |
|                               |                               | **Element**         | **Wave**        | **Chackra**                 | **Spiritual Laws**   | **Jyotirlinga** | **Deadly Sins** | **Brahmajāla Sūtra**     | **Imams**            | **Olympian gods** | **Tribes of Israel** | **Apostles**                | **Arcane Tarot**         | **Zodiac Sign** | **Chinese zodiac** | **Month**             | **Day**   | **Alchemical stage** | **Math Concept**        | **Physics Concept**    | **Programming Pattern** | **Programming Concept** |
...
| **[Work](#work)**             | [Productivity](#productivity) | [Earth](#earth)     | Longitudinal    | Crown, Throat, Solar Plexus | Intention and Desire | Nageshvara      | Sloth           | Idle                     | Ali al-Hadi          | Hephaestus        | Asher                | James the Greater           | Hermit                   | Capricorn       | Rat                | October               | Monday    | Exaltation           | Operations research     | Kinetics               | Composition | Scheduling algorithm    |
